	...
	function create(i){//封装产品类函数
		...
		$.ajax({
			...
			success : function(data){
				...
				$(".product div").eq(0).find("a").attr("href","../html/detail-page1.html");
				$(".product div").eq(1).find("a").attr("href","../html/detail-page2.html");
				$(".product div").eq(2).find("a").attr("href","../html/detail-page3.html");
